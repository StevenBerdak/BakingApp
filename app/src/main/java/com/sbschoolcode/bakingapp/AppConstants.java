...
public class AppConstants {
    ...
    public static final int HTTP_DOWNLOAD_JOB_ID = 123;
    public static final int INSERT_RECIPES_JOB_ID = 456;
    ...
    public static final String BUNDLE_EXTRA_STEP_DETAIL_INDEX = "bundle_extra_step_index";
    ...
    public static final String PREF_RECIPE_API_ID = "pref_recipe_api_id";
    public static final String PREF_STEP_INDEX = "pref_step_index";
}
